...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.projects.shellEnv.title": "Entorno de shell",
  "settings.projects.shellEnv.state.loading": "Cargando...",
  "settings.projects.shellEnv.state.loadFailed": "No se pudo leer la configuración de este proyecto. No se cambiará nada hasta que se cargue.",
  "settings.projects.shellEnv.description": "Carga el entorno de desarrollo de este proyecto (devenv, direnv, un script de shell) y lo aplica a Git, la terminal y las acciones del proyecto.",
  "settings.projects.shellEnv.enabled": "Activar para este proyecto",
  "settings.projects.shellEnv.disabledWarning": "Guardado pero desactivado: el comando no se ejecutará hasta que lo actives.",
  "settings.projects.shellEnv.command.label": "Comando de entorno",
  "settings.projects.shellEnv.command.placeholder": "devenv print-dev-env --json",
  "settings.projects.shellEnv.command.info": "Un comando cuya salida describe el entorno. Compatible con: devenv print-dev-env --json, direnv export json o líneas export/NOMBRE=valor. Se ejecuta desde la raíz del proyecto.",
  "settings.projects.shellEnv.mode.label": "Tratamiento del PATH",
  "settings.projects.shellEnv.mode.overlay": "Anteponer al PATH del sistema",
  "settings.projects.shellEnv.mode.replace": "Reemplazar el PATH del sistema",
  "settings.projects.shellEnv.mode.info": "Anteponer mantiene accesibles las herramientas del sistema y coloca primero las del proyecto. Reemplazar usa el PATH del proyecto tal cual.",
  "settings.projects.shellEnv.vars.label": "Variables adicionales",
  "settings.projects.shellEnv.vars.info": "Pares NOMBRE=valor opcionales, uno por línea, aplicados sobre la salida del comando. Tienen prioridad sobre los valores interpretados.",
  "settings.projects.shellEnv.vars.placeholder": "GOFLAGS=-mod=vendor",
  "settings.projects.shellEnv.vars.invalid": "No es una línea NOMBRE=valor válida: {names}",
  "settings.projects.shellEnv.trustInfo": "El comando se ejecuta localmente desde tu propia configuración, nunca desde el repositorio. Nada se ejecuta hasta que lo actives aquí.",
  "settings.projects.shellEnv.toast.saveFailed": "No se pudo guardar el entorno de shell del proyecto",
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': 'No se encontró el paquete {name} en el registro',
  ...
  'settings.plugins.registry.badge.network.tooltip': 'No se pudo conectar con el registro de paquetes',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': 'Paquete no encontrado en el registro',
