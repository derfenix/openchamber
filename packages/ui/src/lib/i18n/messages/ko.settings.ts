...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.projects.shellEnv.title': '셸 환경',
  'settings.projects.shellEnv.state.loading': '로딩 중...',
  'settings.projects.shellEnv.state.loadFailed': '이 프로젝트의 설정을 읽지 못했습니다. 불러올 때까지 아무것도 변경되지 않습니다.',
  'settings.projects.shellEnv.description': '이 프로젝트의 개발 환경(devenv, direnv, 셸 스크립트)을 불러와 Git, 터미널, 프로젝트 작업에 적용합니다.',
  'settings.projects.shellEnv.enabled': '이 프로젝트에서 사용',
  'settings.projects.shellEnv.disabledWarning': '저장되었지만 꺼져 있습니다. 사용 설정하기 전에는 명령이 실행되지 않습니다.',
  'settings.projects.shellEnv.command.label': '환경 명령',
  'settings.projects.shellEnv.command.placeholder': 'devenv print-dev-env --json',
  'settings.projects.shellEnv.command.info': '출력으로 환경을 설명하는 명령입니다. 지원: devenv print-dev-env --json, direnv export json, export/NAME=value 줄. 프로젝트 루트에서 실행됩니다.',
  'settings.projects.shellEnv.mode.label': 'PATH 처리',
  'settings.projects.shellEnv.mode.overlay': '시스템 PATH 앞에 추가',
  'settings.projects.shellEnv.mode.replace': '시스템 PATH 교체',
  'settings.projects.shellEnv.mode.info': '앞에 추가하면 시스템 도구를 그대로 쓰면서 프로젝트 도구가 우선합니다. 교체는 프로젝트의 PATH를 그대로 사용합니다.',
  'settings.projects.shellEnv.vars.label': '추가 변수',
  'settings.projects.shellEnv.vars.info': '선택 사항인 NAME=value 쌍을 한 줄에 하나씩. 명령 출력 위에 적용되며 파싱된 값보다 우선합니다.',
  'settings.projects.shellEnv.vars.placeholder': 'GOFLAGS=-mod=vendor',
  'settings.projects.shellEnv.vars.invalid': '올바른 NAME=value 줄이 아닙니다: {names}',
  'settings.projects.shellEnv.trustInfo': '이 명령은 저장소가 아니라 내 설정에서 로컬로 실행됩니다. 여기에서 사용 설정하기 전에는 아무것도 실행되지 않습니다.',
  'settings.projects.shellEnv.toast.saveFailed': '프로젝트 셸 환경을 저장하지 못했습니다',
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': '레지스트리에서 패키지 {name}을(를) 찾을 수 없습니다',
  ...
  'settings.plugins.registry.badge.network.tooltip': '패키지 레지스트리에 연결할 수 없습니다',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': '레지스트리에서 패키지를 찾을 수 없습니다',
