...
export const settingsDict = {
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': 'Nie znaleziono pakietu {name} w rejestrze',
  ...
  'settings.plugins.registry.badge.network.tooltip': 'Nie można połączyć się z rejestrem pakietów',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': 'Nie znaleziono pakietu w rejestrze',
  ...
  'settings.projects.shellEnv.title': 'Środowisko powłoki',
  'settings.projects.shellEnv.state.loading': 'Ładowanie...',
  'settings.projects.shellEnv.state.loadFailed': 'Nie udało się odczytać konfiguracji tego projektu. Nic nie zostanie zmienione, dopóki się nie wczyta.',
  'settings.projects.shellEnv.description': 'Ładuje środowisko programistyczne tego projektu (devenv, direnv, skrypt powłoki) i stosuje je do Git, terminala i akcji projektu.',
  'settings.projects.shellEnv.enabled': 'Włącz dla tego projektu',
  'settings.projects.shellEnv.disabledWarning': 'Zapisano, ale wyłączone: polecenie nie uruchomi się, dopóki go nie włączysz.',
  'settings.projects.shellEnv.command.label': 'Polecenie środowiska',
  'settings.projects.shellEnv.command.placeholder': 'devenv print-dev-env --json',
  'settings.projects.shellEnv.command.info': 'Polecenie, którego wyjście opisuje środowisko. Obsługiwane: devenv print-dev-env --json, direnv export json lub wiersze export/NAZWA=wartość. Uruchamia się z katalogu głównego projektu.',
  'settings.projects.shellEnv.mode.label': 'Obsługa PATH',
  'settings.projects.shellEnv.mode.overlay': 'Dodaj przed PATH systemowym',
  'settings.projects.shellEnv.mode.replace': 'Zastąp PATH systemowy',
  'settings.projects.shellEnv.mode.info': 'Dodanie z przodu zachowuje dostęp do narzędzi systemowych i stawia narzędzia projektu na pierwszym miejscu. Zastąpienie używa dokładnie PATH projektu.',
  'settings.projects.shellEnv.vars.label': 'Dodatkowe zmienne',
  'settings.projects.shellEnv.vars.info': 'Opcjonalne pary NAZWA=wartość, po jednej w wierszu, nakładane na wyjście polecenia. Mają pierwszeństwo nad odczytanymi wartościami.',
  'settings.projects.shellEnv.vars.placeholder': 'GOFLAGS=-mod=vendor',
  'settings.projects.shellEnv.vars.invalid': 'To nie jest prawidłowy wiersz NAZWA=wartość: {names}',
  'settings.projects.shellEnv.trustInfo': 'Polecenie uruchamia się lokalnie z Twoich własnych ustawień, nigdy z repozytorium. Nic się nie uruchomi, dopóki nie włączysz go tutaj.',
  'settings.projects.shellEnv.toast.saveFailed': 'Nie udało się zapisać środowiska powłoki projektu',
