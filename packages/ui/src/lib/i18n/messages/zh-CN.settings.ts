...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.projects.shellEnv.title': 'Shell 环境',
  'settings.projects.shellEnv.state.loading': '加载中...',
  'settings.projects.shellEnv.state.loadFailed': '无法读取此项目的配置。在加载完成前不会更改任何内容。',
  'settings.projects.shellEnv.description': '加载此项目的开发环境（devenv、direnv、shell 脚本），并应用到 Git、终端和项目操作。',
  'settings.projects.shellEnv.enabled': '为此项目启用',
  'settings.projects.shellEnv.disabledWarning': '已保存但未启用：在你启用之前，该命令不会运行。',
  'settings.projects.shellEnv.command.label': '环境命令',
  'settings.projects.shellEnv.command.placeholder': 'devenv print-dev-env --json',
  'settings.projects.shellEnv.command.info': '其输出描述环境的命令。支持：devenv print-dev-env --json、direnv export json 或 export/NAME=value 行。从项目根目录运行。',
  'settings.projects.shellEnv.mode.label': 'PATH 处理',
  'settings.projects.shellEnv.mode.overlay': '前置到系统 PATH',
  'settings.projects.shellEnv.mode.replace': '替换系统 PATH',
  'settings.projects.shellEnv.mode.info': '前置可让系统工具仍可访问，并将项目工具放在最前。替换则完全使用项目的 PATH。',
  'settings.projects.shellEnv.vars.label': '额外变量',
  'settings.projects.shellEnv.vars.info': '可选的 NAME=value 对，每行一个，叠加在命令输出之上。它们优先于解析出的值。',
  ...
  'settings.projects.shellEnv.trustInfo': '该命令从你自己的设置本地运行，绝不会来自仓库。在你于此处启用之前不会运行任何内容。',
  'settings.projects.shellEnv.toast.saveFailed': '保存项目 Shell 环境失败',
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': '注册表中找不到包 {name}',
  ...
  'settings.plugins.registry.badge.network.tooltip': '无法连接到包注册表',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': '注册表中找不到该包',
