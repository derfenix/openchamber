...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.projects.shellEnv.title': 'Shell 環境',
  'settings.projects.shellEnv.state.loading': '載入中...',
  'settings.projects.shellEnv.state.loadFailed': '無法讀取此專案的設定。在載入完成前不會變更任何內容。',
  'settings.projects.shellEnv.description': '載入此專案的開發環境（devenv、direnv、shell 指令碼），並套用到 Git、終端機與專案動作。',
  'settings.projects.shellEnv.enabled': '為此專案啟用',
  'settings.projects.shellEnv.disabledWarning': '已儲存但未啟用：在你啟用之前，此指令不會執行。',
  'settings.projects.shellEnv.command.label': '環境指令',
  'settings.projects.shellEnv.command.placeholder': 'devenv print-dev-env --json',
  'settings.projects.shellEnv.command.info': '其輸出描述環境的指令。支援：devenv print-dev-env --json、direnv export json 或 export/NAME=value 行。從專案根目錄執行。',
  'settings.projects.shellEnv.mode.label': 'PATH 處理',
  'settings.projects.shellEnv.mode.overlay': '前置到系統 PATH',
  'settings.projects.shellEnv.mode.replace': '取代系統 PATH',
  'settings.projects.shellEnv.mode.info': '前置可讓系統工具仍可存取，並將專案工具放在最前。取代則完全使用專案的 PATH。',
  'settings.projects.shellEnv.vars.label': '額外變數',
  'settings.projects.shellEnv.vars.info': '選用的 NAME=value 配對，每行一個，疊加在指令輸出之上。它們優先於解析出的值。',
  'settings.projects.shellEnv.vars.placeholder': 'GOFLAGS=-mod=vendor',
  'settings.projects.shellEnv.vars.invalid': '不是有效的 NAME=value 行：{names}',
  'settings.projects.shellEnv.trustInfo': '此指令從你自己的設定在本機執行，絕不會來自儲存庫。在你於此啟用之前不會執行任何內容。',
  'settings.projects.shellEnv.toast.saveFailed': '儲存專案 Shell 環境失敗',
  ...
  'settings.plugins.registry.badge.missingPackage.tooltip': '套件庫中找不到套件 {name}',
  'settings.plugins.registry.badge.missingVersion.tooltip': '{name} 的版本 {version} 尚未發布',
  'settings.plugins.registry.badge.network.tooltip': '無法連線到套件庫',
  ...
  'settings.plugins.registry.banner.invalid.missingPackage': '套件庫中找不到該套件',
